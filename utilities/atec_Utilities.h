...
namespace atec
{
    ...
    public:
        ...
        static double transpo2freqSampler(double transpo, long long int N, double sampleRate);
        ...
        static double bufReadInterp(int channel, double readIdx, const float* bufPtr, long long int N);
